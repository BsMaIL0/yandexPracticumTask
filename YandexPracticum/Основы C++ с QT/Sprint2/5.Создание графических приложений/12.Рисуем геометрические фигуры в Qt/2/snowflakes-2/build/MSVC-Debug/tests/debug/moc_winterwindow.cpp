...
namespace {
struct qt_meta_tag_ZN12WinterWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12WinterWindowE = QtMocHelpers::stringData(
    "WinterWindow",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12WinterWindowE[] = {
...
Q_CONSTINIT const QMetaObject WinterWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12WinterWindowE.offsetsAndSizes,
    qt_meta_data_ZN12WinterWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12WinterWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *WinterWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12WinterWindowE.stringdata0))
