...
static constexpr auto qt_meta_stringdata_ZN8MyWindowE = QtMocHelpers::stringData(
    "MyWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8MyWindowE[] = {
...
Q_CONSTINIT const QMetaObject MyWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8MyWindowE.offsetsAndSizes,
    qt_meta_data_ZN8MyWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8MyWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8MyWindowE.stringdata0))
